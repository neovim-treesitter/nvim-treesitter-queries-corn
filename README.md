# nvim-treesitter-queries-corn

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-corn/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-corn/actions/workflows/validate.yml)

Neovim tree-sitter queries for **corn**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-corn",
...
- [ ] Changes are scoped to `corn` — do not include files for other languages
